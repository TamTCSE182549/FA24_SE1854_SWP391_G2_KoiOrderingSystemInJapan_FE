...
const BookingKoi = () => {
  ...
  return (
    <div className="container mx-auto py-10 px-4 mt-40">
      ...
      <form
        onSubmit={editingBookingId ? handleUpdateBooking : handleSubmit}
      ...
      >
        ...
        <div className="mb-4">
          ...
          >
            ...
            {kois.map((koi) => (
              <option key={koi.id} value={koi.id} className="text-black">
                {koi.koiName}
              </option>
            ))}
          </select>
        ...
        {bookingDetails.length > 0 && (
          <div className="mb-4">
            <Title level={4} className="text-xl font-bold text-black mb-2">
              Booking Koi Details
            </Title>
