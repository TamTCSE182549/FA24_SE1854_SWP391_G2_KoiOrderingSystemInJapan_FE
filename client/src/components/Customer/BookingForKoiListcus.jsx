    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="space-y-1">
          ...
          <div className="text-xs text-gray-500">VAT: {record.vat * 100}%</div>
        </div>
      ),
    },
    {
                      ...
                      >
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <p className="font-medium">
                              {koi.unitPrice.toLocaleString("vi-VN")} VND
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="font-medium text-blue-600">
                              {koi.totalAmount.toLocaleString("vi-VN")} VND
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {bookingDetail.totalAmount.toLocaleString("vi-VN")} VND
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-500">VAT Amount</p>
                      <p className="font-medium">
                        {bookingDetail.vatAmount.toLocaleString("vi-VN")} VND
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-500">Discount</p>
                      <p className="font-medium text-red-500">
                        -{bookingDetail.discountAmount.toLocaleString("vi-VN")}{" "}
                        VND
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="font-medium text-emerald-600">
                        {bookingDetail.totalAmountWithVAT.toLocaleString(
                          "vi-VN"
                        )}{" "}
                        VND
                      </p>
